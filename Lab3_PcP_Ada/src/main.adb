...
procedure Main is
   ...
   begin
      ...
      Put_Line ("Supplier #" & Supplier_Id'Img & " finished working");
   end Supplier_Task;
   ...
   begin
      ...
      while not ItemControl.Is_Consumption_Complete loop
         ...
         begin
            Put_Line ("Receiver #" & Receiver_Id'Img & " took " & Item_Value);
...
begin
  Put_Line ("Total Suppliers: " & Num_Suppliers'Image);
   Put_Line ("Total Receivers: " & Num_Receivers'Image);
   Put_Line ("Total Items Produced: " & Total_Items'Image);
   Put_Line ("Storage Size: " & Storage_Size'Image);
   declare
